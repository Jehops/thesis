...
\begin{figure}
  ...
  \begin{subfigure}[t]{.49\textwidth}
    ...
    plot(sepia.tre,show.node.label=T,no.margin=T,cex=2)
    #nodelabels("Root",5,frame='n',adj=c(-.2,.35),cex=2)
    #nodelabels("1",6,frame='n',adj=c(-.2,.35),cex=2)
    #nodelabels("2",7,frame='n',adj=c(-.2,.35),cex=2)
  ...
  \begin{subfigure}[t]{.49\textwidth}
    ...
    nodelabels("Sepia esculenta",4,frame='n',cex=2,adj=c(-.05,-.1))
    nodelabels("Sepia lycidas",3,frame='n',cex=2,adj=c(.7,-.4))
    nodelabels("Sepia pharaonis",1,frame='n',cex=2,adj=c(.4,1.05))
    nodelabels("Sepia aculeata",2,frame='n',cex=2,adj=c(1.07,.8))
